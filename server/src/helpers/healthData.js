const healthData = (data) => {
  return {
    ...
    healthy_probability: (data.health_assessment.is_healthy_probability * 100).toFixed(),
    disease_name: data.health_assessment.diseases[0].name,
    disease_probability: (data.health_assessment.diseases[0].probability * 100).toFixed(),
